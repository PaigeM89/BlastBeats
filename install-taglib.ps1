$env:TAGLIB_DST_DIR = "$PWD/external/taglib"

cd taglib
cmake -B $env:TAGLIB_DST_DIR -DBUILD_SHARED_LIBS=OFF -DBUILD_TESTING=OFF -DBUILD_EXAMPLES=OFF -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE="$env:VCPKG_ROOT/scripts/buildsystems/vcpkg.cmake"
